...
- (void)loadView {
    ...
    self.mediaControl = [[NELivePlayerControl alloc] initWithFrame:CGRectMake(0, 0, screenWidth, screenHeight)];
    ...
    //顶部控制栏
    self.topControlView    = [[UIView alloc] initWithFrame:CGRectMake(0, 0, screenWidth, 40)];
    ...
    //文件名
    self.fileName = [[UILabel alloc] initWithFrame:CGRectMake(70, 0, screenWidth - 140, 40)];
    ...
    [self.bufferingIndicate setCenter:CGPointMake(screenWidth/2, screenHeight/2)];
    ...
    [self.bufferingReminder setCenter:CGPointMake(screenWidth/2, screenHeight/2 - 50)];
    ...
    //底部控制栏
    self.bottomControlView = [[UIView alloc] initWithFrame:CGRectMake(0, screenHeight - 50, screenWidth, 50)];
    ...
    //播放进度条
    self.videoProgress = [[UISlider alloc] initWithFrame:CGRectMake(100, 10, screenWidth-320, 30)];
    ...
    //文件总时长
    self.totalDuration = [[UILabel alloc] initWithFrame:CGRectMake(screenWidth-215, 15, 50, 20)];
    ...
    self.audioBtn.frame = CGRectMake(screenWidth-150, 5, 40, 40);
    ...
    self.muteBtn.frame = CGRectMake(screenWidth-150, 5, 40, 40);
    ...
    self.snapshotBtn.frame = CGRectMake(screenWidth-100, 5, 40, 40);
